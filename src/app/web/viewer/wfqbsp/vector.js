...
exports.origin = [0.0, 0.0, 0.0];
exports.perpendicular = function (v) {
    var pos = 0;
    var minelem = 1;
    ...
    exports.normalize(dst);
    return dst;
};
exports.rotatePointAroundVector = function (dir, point, degrees) {
    var r = exports.perpendicular(dir);
    var up = exports.crossProduct(r, dir);
    var m = [
        [r[0], up[0], dir[0]],
        [r[1], up[1], dir[1]],
        [r[2], up[2], dir[2]]
    ...
    var rot = exports.concatRotations(exports.concatRotations(m, zrot), im);
    return [
...
exports.anglemod = function (a) {
    return (a % 360.0 + 360.0) % 360.0;
};
exports.boxOnPlaneSide = function (emins, emaxs, p) {
    if (p.type <= 2) {
    ...
    switch (p.signbits) {
        ...
        case 7:
            ...
            break;
        default:
            throw new Error('Vec.BoxOnPlaneSide: Bad signbits');
    }
    var sides = 0;
    if (dist1 >= p.dist)
        sides = 1;
...
exports.angleVectors = function (angles, forward = null, right = null, up = null) {
    var angle;
...
exports.concatRotations = function (m1, m2) {
    return [
        [
